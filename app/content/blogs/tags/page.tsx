...
import { Home, ChevronsUp, Edit3, Trash2, ChevronDown } from 'lucide-react'
...
const tags = [
  { name: 'hrms', date: '12 Sep 2024' },
  { name: 'recruitment', date: '24 Oct 2024' },
  { name: 'hrtech', date: '18 Feb 2024' },
  { name: 'hrmsfuture', date: '17 Oct 2024' },
  { name: 'datasecurity', date: '20 Jul 2024' },
  { name: 'hrsoftware', date: '10 Apr 2024' },
  { name: 'htrrends', date: '29 Aug 2024' },
  { name: 'hrmsbenefits', date: '22 Feb 2024' },
  { name: 'hrmstools', date: '03 Nov 2024' },
  { name: 'hrtechinnovation', date: '17 Dec 2024' },
]
  ...
  return (
    <>
      ...
      <div className="mb-3 flex flex-col gap-3 md:flex-row md:items-center md:justify-between">
        <div>
          <h2 className="mb-1 text-2xl font-semibold">Blog Tags</h2>
          <nav>
            <ol className="flex items-center text-xs text-gray-600">
              ...
              <li className="flex items-center">
                <span className="mx-1 text-xs">/</span>
                <span className="text-gray-900">Blog Tags</span>
              </li>
            </ol>
          </nav>
        </div>
      ...
      <Card>
        <CardHeader className="flex flex-row items-center justify-between gap-3 border-b border-gray-200 px-4 py-3">
          <h5 className="text-base font-semibold">Blog Tags List</h5>
              ...
              <tbody className="divide-y divide-gray-200">
                {tags.map(tag => (
                  <tr key={tag.name} className="hover:bg-gray-50">
                    ...
                    <td className="px-4 py-3 text-gray-700">{tag.date}</td>
        ...
        <DialogContent className="max-w-md">
          ...
          <div className="space-y-4">
            <div>
              ...
              <Input placeholder="Enter Tag" className="h-10" />
            </div>
          </div>
        ...
        <DialogContent className="max-w-md">
          ...
          <div className="space-y-4">
            <div>
              ...
              <Input defaultValue="hrms" className="h-10" />
            </div>
          </div>
          <DialogFooter className="mt-6">
            <Button
